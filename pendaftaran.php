...
<body>
    ...
    <div class="content">
        ...
        <ol>
            ...
            <li>Mahasiswa melakukan pembayaran ke nomor Virtual Account yang dikirimkan ke email masing-masing calon penghuni Asrama.</li>
            <li>Setelah pembayaran, mahasiswa akan menerima notifikasi melalui email terkait keberhasilan transaksi pembayaran.</li>
            <li>Setelah pembayaran terkonfirmasi, mahasiswa resmi terdaftar sebagai penghuni Asrama Mahasiswa Kita.</li>
        </ol>
    </div>
    <div class="actions">
